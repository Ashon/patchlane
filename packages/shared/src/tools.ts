...
export const publicGitHubToolSettingsSchema = githubToolSettingsSchema
  .omit({ token: true })
  .extend({
...
export type PublicGitHubToolSettings = z.infer<
  typeof publicGitHubToolSettingsSchema
>
export type PublicToolSettings = z.infer<typeof publicToolSettingsSchema>
export type UpdateGitHubToolSettingsInput = z.infer<
  typeof updateGitHubToolSettingsSchema
>
