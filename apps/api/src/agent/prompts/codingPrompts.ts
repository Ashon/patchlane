...
export const postEditCompletionPrompt = [
  ...
  'Next, run the narrowest relevant verification, inspect git status/diff, then call finish.',
...
export const postDiffCompletionPrompt = [
  ...
  'If the changes satisfy the task and verification has run, call finish now.',
